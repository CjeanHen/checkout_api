...
from .views.survey_views import Surveys, SurveyDetail, SurveysForAll, TakeSurvey
...
urlpatterns = [
    ...
    path('surveysallusers/<int:pk>', TakeSurvey.as_view(), name='take_survey'),
    path('availablesurveys/', SurveysForAll.as_view(), name='takesurveys'),
